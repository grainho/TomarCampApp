namespace TomarCampApp.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ApplicationDbContext>
    {
        ...
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            new Criancas {ID=1, Nome="Tania Vieira", Idade=6, Doencas="Asma", NumCC="270820676", PaiFK=1},
            new Criancas {ID=2, Nome="Luis Santos", Idade=8, Doencas="Alergia", NumCC="270720676", PaiFK=1},
            new Criancas {ID=3, Nome="Carlos Vieira", Idade=10, Doencas="Intolerancia", NumCC="270620676", PaiFK=2},
            new Criancas {ID=4, Nome="Jose Pais", Idade=9, Doencas="Alergia", NumCC="270520676", PaiFK=3},
            new Criancas {ID=5, Nome="Andreia Ferreira", Idade=11, Doencas="Alergia", NumCC="270420676", PaiFK=4},
            new Criancas {ID=6, Nome="Joana Pires", Idade=14, Doencas="Asma", NumCC="270320676", PaiFK=5},
            new Criancas {ID=7, Nome="Ana Silva", Idade=13, Doencas="", NumCC="270220676", PaiFK=5}
};
